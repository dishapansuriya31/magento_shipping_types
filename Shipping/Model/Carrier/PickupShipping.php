    ...
    \Magento\Shipping\Model\Carrier\CarrierInterface
{
    ...
    /**
     * Get liftgate value from quote
     * 
     * @param \Magento\Quote\Model\Quote|null $quote
     * @return int
     */
    private function getLiftgateValue($quote)
    {
        return $quote ? (int)$quote->getData('liftgate') : 0;
    }

    /**
     * Get delivery appointment value from quote
     * 
     * @param \Magento\Quote\Model\Quote|null $quote
     * @return int
     */
    private function getDeliveryAppointmentValue($quote)
    {
        return $quote ? (int)$quote->getData('delivery_appointment') : 0;
    }
